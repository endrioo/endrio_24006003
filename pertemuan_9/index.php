...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron text-center">
      <h1>Belajar Pemograman itu Mudah</h1>
      <p>
        Tingkatkan Skill Pemograman Kamu belajar tutorial pemograman gratis!
      </p>
    </div>
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="thumbnail">
            <a href="artikel.html">
              <img
                src="assets/gambar/HTML_&_CSS.png"
                alt="Html & css"
                width="100%"
              />
            </a>
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <a href="artikel.html">
              <img
                src="assets/gambar/Programming.png"
                alt="Programming"
                width="100%"
              />
            </a>
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <a href="artikel.html">
              <img
                src="assets/gambar/Desain_UI_&_UX.png"
                alt="Html & css"
                width="100%"
              />
            </a>
            <div class="caption">
              <h3>Belajar Design UI & UX</h3>
              <p>
                Lorem Ipsum is simply dummy text of the printing and typesetting
                industry. Lorem Ipsum has been the industry's standard dummy
                text ever since the 1500s, when an unknown printer took a galley
